...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    public void draw(Graphics g) {
        ...
        // g.fillRoundRect(food.x * tileSize, food.y * tileSize, tileSize, tileSize, 25, 25);
        ...
        // g.fillRoundRect(snakeHead.x * tileSize, snakeHead.y * tileSize, tileSize, tileSize, 15, 15);
